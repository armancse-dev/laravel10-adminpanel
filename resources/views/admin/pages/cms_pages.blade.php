                                        ...
                                        @foreach ($CmsPages as $page)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a class="confirmDelete" name="CMS Page" title="Delete Cms Page" style='color:blue' href="javascript:void(0)" record="cms-page" recordid="{{ $page['id'] }}" <?php /* href="{{ url('admin/delete-cms-page/' . $page['id']) }}" */?> ><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
